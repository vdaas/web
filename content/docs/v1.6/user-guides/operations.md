...
The levels are defined in [the Coding Style document](/docs/v1.6/contributing/coding-style#logging).
...
<img src="/images/v1.6/guides/operations/grafana-example.png" />
