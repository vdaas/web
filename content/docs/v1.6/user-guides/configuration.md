...
The logging level is defined in [the Coding Style Guide](/docs/v1.6/contributing/coding-style#logging).
...
The API specs are placed in [Vald APIs](/docs/v1.6/api).
...
Please refer to [the Vald operation guide](/docs/v1.6/user-guides/configuration) for more detail.
...
[The capacity planning page](/docs/v1.6/user-guides/capacity-planning) helps to estimate the resources.
