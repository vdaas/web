---
title: "Vald Agent Standalone on K8s_v1.6/Tutorial"
...
In [Get Started](/docs/v1.6/tutorial/get-started), you may use 4 kinds of components to deploy Vald.
...
<img src="/images/v1.6/tutorial/vald-agent-standalone-on-k8s.svg">
