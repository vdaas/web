...
For more information about Vald's architecture, please refer to [Architecture](/docs/v1.6/overview/architecture).

<img src="/images/v1.6/tutorial/getstarted.svg" />
...
If you are interested, please refer to [SDKs](/docs/v1.6/user-guides/sdks).<br>
...
- [Vald Agent Standalone on k8s](/docs/v1.6/tutorial/vald-agent-standalone-on-k8s)
- [Vald Agent on Docker](/docs/v1.6/tutorial/vald-agent-standalone-on-docker)
