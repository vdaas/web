---
title: "Vald Agent Standalone on K8s_v1.4/Tutorial"
...
In the [Get Started](/docs/v1.4/tutorial/get-started), you may use 4 kinds of components to deploy Vald.
...
<img src="/images/v1.4/tutorial/vald-agent-standalone-on-k8s.png">
