---
title: "Get Started_v1.4/Tutorial"
...
For more information about Vald's architecture, please refer to [Architecture](/docs/v1.4/docs/overview/architecture).

<img src="/images/v1.4/tutorial/getstarted.png" />
...
If you are interested in, please refer to [SDKs](/docs/v1.4/user-guides/sdks).<br>
...
- [Vald Agent Standalone on k8s](/docs/v1.4/tutorial/vald-agent-standalone-on-k8s)
- [Vald Agent on Docker](/docs/v1.4/tutorial/vald-agent-standalone-on-docker)
