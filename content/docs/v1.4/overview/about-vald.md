...
Please refer to the [architecture overview](/docs/v1.4/overview/architecture) for more details about the architecture and how each component in Vald works together.

## Try Vald

Please refer to [Get Started](/docs/v1.4/tutorial/get-started) to try Vald :)
