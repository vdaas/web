---
title: "About Vald_content/Docs/V0.0.56/Overview"
date: 2020-09-18T17:08:36+09:00
draft: true
weight: 0
menu:
  overview:
...
Please refer to the [architecture overview](/docs/v0.0.56/overview/architecture) for more details about the architecture and how each component in Vald works together.

## Try Vald

Please refer to [Get Started](/docs/v0.0.56/tutorial/get-started) to try Vald :)
