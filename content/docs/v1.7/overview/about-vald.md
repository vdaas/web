---
title: "About Vald_v1.7/Overview"
date: 2025-08-20T04:53:11Z
draft: false
weight: 100
...
Please refer to the [architecture overview](/docs/v1.7/overview/architecture) for more details about the architecture and how each component in Vald works together.

## Try Vald

Please refer to [Get Started](/docs/v1.7/tutorial/get-started) to try Vald :)
