...
<div class="notice">
This implementation structure is generated by the `make gotests/gen` command for all unit test files by applying the custom unit test template using <a href="https://github.com/cweill/gotests">gotests</a>.
<br>
...
For the implemented unit test, we cannot deal with it by executing `make gotests/gen` command.
