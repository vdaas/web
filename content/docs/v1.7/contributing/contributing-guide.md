...
date: 2023-04-25T11:56:59+09:00
draft: false
weight: 100
menu:
  contributing:
...
<div class="notice">
This implementation structure is generated by the <code class="zsh" data-lang="zsh">make gotests/gen</code> command for all unit test files by applying the custom unit test template using <a href="https://github.com/cweill/gotests">gotests</a>.
<br>
...
For the implemented unit test, we cannot deal with it by executing  <code class="zsh" data-lang="zsh">make gotests/gen</code> command.
