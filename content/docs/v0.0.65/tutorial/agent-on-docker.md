---
title: "Agent on Docker_content/Docs/V0.0.65/Tutorial"
...
Fashion-mnist is used as an example dataset, same as [Get Started](/docs/v0.0.65/tutorial/get-started).
...
1. Running example
    ...
    If you want to learn the detail of running an example, please refer to the tutorial of [standalone Vald Agent on kubernetes](/docs/v0.0.65/tutorial/get-started/#run-using-example-code-1).
