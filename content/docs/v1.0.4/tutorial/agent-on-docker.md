---
title: "Agent on Docker_content/Docs/V1.0.4/Tutorial"
date: 2021-03-17T14:48:23+09:00
draft: true
weight: 0
menu:
  tutorial:
...
Fashion-mnist is used as an example dataset, same as [Get Started](/docs/v1.0.4/tutorial/get-started).
...
1. Running example
    ...
    If you want to learn the detail of running an example, please refer to the tutorial of [standalone Vald Agent on kubernetes](/docs/v1.0.4/tutorial/get-started/#run-using-example-code-1).
