---
title: "Filtering Configuration_v1.5/User Guides"
...
Before using the filtering functions, please check [the Vald Filter Gateway document](/docs/v1.5/overview/component/filter-gatewya) first for what you can do.
...
For more details, please refer to [the Vald Filter Gateway document](/docs/v1.5/overview/component/filter-gatewya)
