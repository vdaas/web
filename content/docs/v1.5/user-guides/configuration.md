---
title: "Configuration_v1.5/User Guides"
...
The logging level is defined in [the Coding Style Guide](/docs/v1.5/contributing/coding-style#logging).
...
The API specs are placed in [Vald APIs](/docs/v1.5/api).
...
Please refer to [the Vald operation guide](/docs/v1.5/user-guides/configuration) for more detail.
...
[The capacity planning page](/docs/v1.5/user-guides/capacity-planning) helps to estimate the resources.
...
Vald Discoverer gets the Node and Pod metrics from [kube-apiserver](https://kubernetes.io/ja/docs/reference/command-line-tools-reference/kube-apiserver/) as described in [Vald Discoverer](/docs/v1.5/overview/component/discoverer).
