---
title: "Lb Gateway_v1.5/Overview/Component"
...
Vald LB Gateway controls insert vector requests based on `index replica` and each Vald Agent Pod resource usage, which [Vald Discoverer](/docs/v1.5/component/discoverer) provides, to avoid uneven resource usage.
...
For more information about Vald Filter Gateway, please refer to [Vald Filter Gateway Overview](/docs/v1.5/component/filter-gateway).
