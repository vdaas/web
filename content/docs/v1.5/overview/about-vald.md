...
date: 2022-03-25T12:30:02+09:00
draft: false
weight: 100
menu:
  overview:
...
Please refer to the [architecture overview](/docs/v1.5/overview/architecture) for more details about the architecture and how each component in Vald works together.

## Try Vald

Please refer to [Get Started](/docs/v1.5/tutorial/get-started) to try Vald :)
