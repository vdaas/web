---
title: "About Vald_content/Docs/V0.0.52/Overview"
...
Please refer to the [architecture overview](/docs/v0.0.52/overview/architecture) for more details about the architecture and how each component in Vald works together.

## Try Vald

Please refer to [Get Started](/docs/v0.0.52/tutorial/get-started) to try Vald :)
