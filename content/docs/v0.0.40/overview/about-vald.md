---
title: "About Vald_content/Docs/V0.0.40/Overview"
date: 2020-06-10T14:34:53+09:00
draft: true
weight: 0
menu:
  overview:
...
Please refer to the [architecture overview](/docs/v0.0.40/overview/architecture) for more details about the architecture and how each component in Vald works together.

## Try Vald

Please refer to [Get Started](/docs/v0.0.40/tutorial/get-started) to try Vald :)
