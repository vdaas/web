---
title: "Get Started_v1.3/Tutorial"
date: 2022-02-17T16:51:43+09:00
draft: false
weight: 100
menu:
  tutorial:
...
For more information about Vald's architecture, please refer to [Architecture](/docs/v1.3/docs/overview/architecture).

<img src="/images/v1.3/tutorial/getstarted.png" />
...
If you are interested in, please refer to [SDKs](/docs/v1.3/user-guides/sdks).<br>
...
- [Vald Agent Standalone on k8s](/docs/v1.3/tutorial/vald-agent-standalone-on-k8s)
- [Vald Agent on Docker](/docs/v1.3/tutorial/vald-agent-standalone-on-docker)
