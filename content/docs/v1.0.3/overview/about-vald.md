---
title: "About Vald_content/Docs/V1.0.3/Overview"
date: 2021-02-19T18:53:45+09:00
draft: true
weight: 0
menu:
  overview:
...
Please refer to the [architecture overview](/docs/v1.0.3/overview/architecture) for more details about the architecture and how each component in Vald works together.

## Try Vald

Please refer to [Get Started](/docs/v1.0.3/tutorial/get-started) to try Vald :)
