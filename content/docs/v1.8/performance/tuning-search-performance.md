---
title: "Tuning Search Performance_v1.8/Performance"
...
1. Measure [Linear Search](/docs/v1.8/docs/api/search#linearsearch-rpc) performance and use it as a baseline for Search API
...
On the client side, parameters of [`Search.Config`](/docs/v1.8/docs/api/search#input) will affect the search result.
