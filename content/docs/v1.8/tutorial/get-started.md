---
title: "Get Started_v1.8/Tutorial"
...
For more information about Vald's architecture, please refer to [Architecture](/docs/v1.8/overview/architecture).

<img src="/images/v1.8/tutorial/getstarted.svg" />
...
If you are interested, please refer to [SDKs](/docs/v1.8/user-guides/sdks).<br>
...
- [Vald Agent Standalone on k8s](/docs/v1.8/tutorial/vald-agent-standalone-on-k8s)
- [Vald Agent on Docker](/docs/v1.8/tutorial/vald-agent-standalone-on-docker)
