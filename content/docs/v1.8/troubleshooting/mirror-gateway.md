---
title: "Mirror Gateway_v1.8/Troubleshooting"
...
Additionally, if you encounter some errors when using API, the [API status code](/docs/v1.8/api/status) helps you, too.

## Insert Operation

Mirror Gateway sends an Update request to its host if some requests are `ALREADY_EXISTS`.

Therefore, in addition to the [Insert API status code](/docs/v1.8/api/insert#status-code), the [Update API status code](/docs/v1.8/api/update#status-code) may also be returned to the user.
...
Therefore, in addition to the [Update API status code](/docs/v1.8/api/update#status-code), the [Insert API status code](/docs/v1.8/api/insert#status-code) may also be returned to the user.
