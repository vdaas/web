---
title: "Mirror Gateway_v1.8/Overview/Component"
date: 2026-09-16T04:40:19Z
draft: false
weight: 600
...
<img src="/images/v1.8/overview/component/mirror-gateway/mirror-gateway.png">

## Responsibility

Vald Mirror Gateway is responsible for the followings:

- Forward user requests ([Insert](/docs/v1.8/api/insert) / [Upsert](/docs/v1.8/api/upsert) / [Update](/docs/v1.8/api/update) / [Remove](/docs/v1.8/api/remove)) to the other Vald Mirror Gateways in the same group.
...
<img src="/images/v1.8/overview/component/mirror-gateway/full-mesh-connection.png">
...
For more information about `ValdMirrorTarget` configuration, please refer to [Custom Resource Configuration](/docs/v1.8/user-guides/mirroring-configuration).

### Request forwarding

<img src="/images/v1.8/overview/component/mirror-gateway/request-forwarding.png">

The Vald Mirror Gateway forwards the incoming user request ([Insert](/docs/v1.8/api/insert) / [Upsert](/docs/v1.8/api/upsert) / [Update](/docs/v1.8/api/update) / [Remove](/docs/v1.8/api/remove)) to other Vald Mirror Gateways.
...
On the other hand, if the incoming user request is an [Object API](/docs/v1.8/api/object) or [Search API](/docs/v1.8/api/search), it is bypassed to only a Vald LB Gateway in its own cluster without forwarding it to other Vald Mirror Gateways.
...
For more information about status code, please refer to [Mirror Gateway Troubleshooting](/docs/v1.8/troubleshooting/mirror-gateway).
