---
title: "Lb Gateway_v1.8/Overview/Component"
date: 2026-09-09T03:59:55Z
draft: false
weight: 200
...
Vald LB Gateway controls insert vector requests based on `index replica` and each Vald Agent Pod resource usage, which [Vald Discoverer](/docs/v1.8/overview/component/discoverer) provides, to avoid uneven resource usage.
...
For more information about Vald Filter Gateway, please refer to [Vald Filter Gateway Overview](/docs/v1.8/overview/component/filter-gateway).
