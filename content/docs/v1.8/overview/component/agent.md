---
title: "Agent_v1.8/Overview/Component"
...
<img src="/images/v1.8/overview/component/agent/ngt.png" alt="NGT Index Creation Mechanism" />

Please refer to [Go Doc](https://pkg.go.dev/github.com/vdaas/vald@v1.8.0/pkg/agent/core/ngt/service) for other functions.
...
<img src="/images/v1.8/overview/component/agent/sidecar_backup.png" />

- Restore
  - When the Vald Agent Pod restarts, the index structure is restored from the external backup files.

<img src="/images/v1.8/overview/component/agent/sidecar_restore.png" />
