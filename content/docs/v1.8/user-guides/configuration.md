---
title: "Configuration_v1.8/User Guides"
date: 2026-09-09T03:59:59Z
draft: false
weight: 100
...
The logging level is defined in [the Coding Style Guide](/docs/v1.8/contributing/coding-style#logging).
...
The API specs are placed in [Vald APIs](/docs/v1.8/api).
...
Please refer to [the Vald operation guide](/docs/v1.8/user-guides/configuration) for more detail.
...
[The capacity planning page](/docs/v1.8/user-guides/capacity-planning) helps to estimate the resources.
...
Vald Discoverer gets the Node and Pod metrics from [kube-apiserver](https://kubernetes.io/docs/reference/command-line-tools-reference/kube-apiserver/) as described in [Vald Discoverer](/docs/v1.8/overview/component/discoverer).
