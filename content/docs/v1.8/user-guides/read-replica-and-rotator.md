---
title: "Read Replica and Rotator_v1.8/User Guides"
...
1. Edit `values.yaml` like below (Please refer to [deployment](/docs/v1.8/user-guides/deployment) for other fields.)
...
<img src="/images/v1.8/guides/read-replica-and-rotator/architecture.png" alt="Read Replica Architecture" />
