---
title: "Filtering Configuration_v1.8/User Guides"
...
Before using the filtering functions, please check [the Vald Filter Gateway document](/docs/v1.8/overview/component/filter-gateway) first for what you can do.
...
For more details, please refer to [the Vald Filter Gateway document](/docs/v1.8/overview/component/filter-gateway)
