---
title: "Deployment_v1.8/User Guides"
...
Please refer to [the basic configuration document](/docs/v1.8/user-guides/configuration).

In addition, as you need, please refer to the followings:

- [Backup Configuration](/docs/v1.8/user-guides/backup-configuration)
- [Filter Configuration](/docs/v1.8/user-guides/filtering-configuration)
