---
title: "Vald Operator_v1.8/User Guides/Vald Operator"
date: 2026-09-16T04:40:20Z
draft: false
weight: 0
---
...
| ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------- |
| [Design Overview](design)                               | Controller architecture, CRD spec, reconcile lifecycle, and environment-variable reference. |
| [Controller Specification](controller-spec)             | Detailed reconcile model, desired-state model, and resource-management rules.               |
| [Resource and Topology Strategy](resource-and-topology) | Agent resource calculation, replica scaling formulas, and topology spread constraints.      |
| [Test Strategy](test-strategy)                          | Test layers, golden file tests, and coverage philosophy.                                    |
