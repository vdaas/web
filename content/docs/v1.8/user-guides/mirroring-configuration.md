---
title: "Mirroring Configuration_v1.8/User Guides"
...
Before you use the mirroring functions, please look at [the Vald Mirror Gateway document](/docs/v1.8/overview/component/mirror-gateway) for what you can do.
...
Please refer to [Cluster Role Configuration](/docs/v1.8/user-guides/cluster-role-binding) about cluster role settings for Mirror Gateway.
