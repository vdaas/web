---
title: "Cluster Role Binding_v1.8/User Guides"
date: 2026-09-09T03:59:58Z
draft: false
weight: 500
...
This service account allows [Vald Discoverer](/docs/v1.8/overview/component/discoverer) to retrieve Node and Pod resource usage from [kube-apiserver](https://kubernetes.io/docs/reference/command-line-tools-reference/kube-apiserver/), and share it to other components in the Vald cluster.

For example, [Vald LB Gateway](/docs/v1.8/overview/component/lb-gateway) will control which Vald Agent to insert based on the Node and Pod resource usage retrieved by Vald Discoverer.

If you are interested, please refer to the [insert data flow](/docs/v1.8/overview/data-flow#insert) for more detail.
...
For more information about Vald Discoverer, please refer [here](/docs/v1.8/overview/component/discoverer).
...
- [Vald Discoverer](/docs/v1.8/overview/component/discoverer)
- [Data Flow](/docs/v1.8/overview/data-flow)
